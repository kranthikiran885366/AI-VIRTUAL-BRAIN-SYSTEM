...
class FaceModel(nn.Module):
    ...
    def __init__(self, num_classes: int):
        ...
        Args:
            num_classes: Number of face classes
        """
        super().__init__()
...
def train_face_model(
    ...
    try:
        ...
        # Preprocess data
        train_data, train_labels = preprocessor.preprocess_face_data(
            data_path=str(output_dir / 'splits'),
            split='train'
        )
        val_data, val_labels = preprocessor.preprocess_face_data(
            data_path=str(output_dir / 'splits'),
            split='val'
        )
        ...
        # Initialize model
        model = FaceModel(num_classes=len(config['face_classes']))
